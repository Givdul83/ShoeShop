...
{
    public abstract class ProductsBaseRepo<TEntity, TContext> where TEntity : class where TContext : ProductDbContext
    {
        private readonly ProductDbContext _context;

        protected ProductsBaseRepo(ProductDbContext context)
        {
            _context = context;
        }
